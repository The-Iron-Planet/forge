...
JobPost.create!(company_name: "Google", location: "Mountain View, CA", user_id: dur_fe_alum.id, curriculum_id: fe.id,
...
JobPost.create!(company_name: "IBM", location: "Austin, TX", user_id: atl_rails_alum.id, curriculum_id: rails.id,
...
JobPost.create!(company_name: "IBM", location: "Austin, TX", user_id: atl_rails_alum.id, curriculum_id: python.id,
...
JobPost.create!(company_name: "Apple", location: "Cupertino, CA", user_id: dur_rails_instructor.id, curriculum_id: rails.id,
